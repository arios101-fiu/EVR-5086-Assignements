...
I started by creating a GitHub account (arios101-fiu) and a GitHub repository with a gitignore and readme.md ([EVR-5086-Assignment1](https://github.com/arios101-fiu/EVR-5086-Assignement1)). I cloned the repository into R Studio, thereby creating a R project. I copied in a \_quarto.yml and index file from another project. I simplified the index file and inserted a reference to create a new reference.bib. Lastly I updated the yml and committed and pushed all changes.
