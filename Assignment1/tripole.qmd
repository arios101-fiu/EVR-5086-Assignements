...
Switch to using python to create @fig-vector and @fig-streamlines. I did not identify any stagnation points. My low values were close together, so a saddle effect didn’t appear as it would if they were spaced farther apart.
